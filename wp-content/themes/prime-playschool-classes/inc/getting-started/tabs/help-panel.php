...
<div id="help-panel" class="panel-left visible">
    ...
    <div class="panel-aside active">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://themeignite.com/products/prime-classes-wordpress-theme' ); ?>" title="<?php esc_attr_e( 'Visit the Documentation', 'prime-playschool-classes' ); ?>" target="_blank">
    ...
    <div class="panel-aside " >
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://wordpress.org/support/theme/prime-playschool-classes/reviews/#new-post' ); ?>" title="<?php esc_attr_e( 'Visit the Review', 'prime-playschool-classes' ); ?>" target="_blank">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://wordpress.org/support/theme/prime-playschool-classes/' ); ?>" title="<?php esc_attr_e( 'Visit the Support', 'prime-playschool-classes' ); ?>" target="_blank">
