...
if ( ! class_exists( 'Prime_Playschool_Classes_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Prime_Playschool_Classes_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Prime_Playschool_Classes_WPTT_WebFont_Loader( $url );
